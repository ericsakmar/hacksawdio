...
// This component will listen for the backend events and update its state accordingly.
export function DownloadStatus() {
  ...
  useEffect(() => {
    ...
    const setupListeners = async () => {
      ...
      unlistenNotEmpty = await listen<void>('download-queue-not-empty', (event) => {
  ...
  return (
    <div>
      <p>Download Queue Status: {isQueueActive ? 'Active' : 'Idle'}</p>
    </div>
  );
}
